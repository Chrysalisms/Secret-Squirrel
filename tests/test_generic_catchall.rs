...
fn test_missing_key() {
    ...
    let input = Bytes::from("    Key = 7331f07936b4d50d37bdcec33d25082737cf45fec53cf4541fecfd27e8588ffa   ");
    ...
    for pm in pattern_matches {
        let score = fe.compute(&pm, 0.5, None, None, &secret_squirrel::types::FragmentMetadata {
            path: "test".to_string(),
