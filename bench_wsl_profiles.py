...
print("--- Running BetterLeaks on WSL Native File System ---")
bl_cmd = 'wsl.exe -e bash -c "/usr/bin/time -v betterleaks dir /root/test_suites/ 2>&1"'
bl_duration, bl_out, bl_err = run_cmd(bl_cmd)

print("--- Running Secret Squirrel (FAST) on WSL Native File System ---")
ss_fast_cmd = 'wsl.exe -e bash -c "/usr/bin/time -v \'/mnt/c/Users/vbode/OneDrive/Desktop/Coding Space/Secret-Squirrel/target/release/squirrel\' detect --profile fast /root/test_suites/ 2>&1"'
ssf_duration, ssf_out, ssf_err = run_cmd(ss_fast_cmd)

print("--- Running Secret Squirrel (DEEP) on WSL Native File System ---")
ss_deep_cmd = 'wsl.exe -e bash -c "/usr/bin/time -v \'/mnt/c/Users/vbode/OneDrive/Desktop/Coding Space/Secret-Squirrel/target/release/squirrel\' detect --profile deep /root/test_suites/ 2>&1"'
